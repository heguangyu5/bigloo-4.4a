...
/*===========================================================================*/
/* COMPILATION: (/home/serrano/prgm/project/bigloo/4.4a/bin/bigloo -srfi enable-gmp -srfi bigloo-unsafe -O3 -fcfa-arithmetic -q -lib-dir /home/serrano/prgm/project/bigloo/4.4a/lib/bigloo/4.4a -rm -copt -w -lib-dir /home/serrano/prgm/project/bigloo/4.4a/lib/bigloo/4.4a -mklib -cc gcc -fsharing -q -no-hello -unsafe -safee -O4 -c Llib/semaphore.scm -indent -o objs/obj_u/Llib/semaphore.c) */
/* GC selection */
...
extern "C"
{
	...
	BGL_EXPORTED_DECL obj_t BGl_modulezd2initializa7ationz75zz__semaphorez00(long,
		char *);
	...
	static obj_t *__cnst;
		...
		DEFINE_STRING(BGl_string1558z00zz__semaphorez00,
		BgL_bgl_string1558za700za7za7_1559za7, "__semaphore", 11);
	      DEFINE_EXPORT_BGL_PROCEDURE(BGl_semaphorezf3zd2envz21zz__semaphorez00,
		BgL_bgl_za762semaphoreza7f3za71560za7,
		BGl_z62semaphorezf3z91zz__semaphorez00, 0L, BUNSPEC, 1);
...
/* module-initialization */
	BGL_EXPORTED_DEF obj_t BGl_modulezd2initializa7ationz75zz__semaphorez00(long
		BgL_checksumz00_1662, char *BgL_fromz00_1663)
	{
		{
			if (CBOOL(BGl_requirezd2initializa7ationz75zz__semaphorez00))
				{
					...
					return BGl_methodzd2initzd2zz__semaphorez00();
				}
			else
				{
					return BUNSPEC;
...
/* semaphore? */
	BGL_EXPORTED_DEF bool_t BGl_semaphorezf3zf3zz__semaphorez00(obj_t BgL_oz00_3)
	{
		{	/* Llib/semaphore.scm 53 */
			return BGL_SEMAPHOREP(BgL_oz00_3);
		}
...
/* &semaphore? */
	obj_t BGl_z62semaphorezf3z91zz__semaphorez00(obj_t BgL_envz00_1660,
		obj_t BgL_oz00_1661)
	{
		{	/* Llib/semaphore.scm 53 */
			return BBOOL(BGl_semaphorezf3zf3zz__semaphorez00(BgL_oz00_1661));
		}
	...
	obj_t BGl_importedzd2moduleszd2initz00zz__semaphorez00()
	{
		{	/* Llib/semaphore.scm 15 */
			return
				...
				BSTRING_TO_STRING(BGl_string1558z00zz__semaphorez00));
		}
